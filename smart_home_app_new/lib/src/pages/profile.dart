                ...
                children: [
                  Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .headlineSmall // Thay headline6 bằng headlineSmall
...
class _TopPortion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        Container(
          margin: const EdgeInsets.only(bottom: 50), // Lỗi cú pháp: 'custom' không hợp lệ
          decoration: const BoxDecoration(
              gradient: LinearGradient(
                  begin: Alignment.bottomCenter,
                  end: Alignment.topCenter,
                  colors: [Color(0xff4C7380), Color(0xff4C7380)]),
